...
abstract partial class AwaiterAdapter
{
	...
	public static AwaiterAdapter CreateTaskTupleAwaiter(Task<object>[] tasks, bool? continueOnCapturedContext = null)
	{
		if (continueOnCapturedContext != null)
		{
			...
			{
				1 => new ConfiguredTaskTupleAwaiter1Adapter(
				...
				2 => new ConfiguredTaskTupleAwaiter2Adapter(
					(tasks[0], tasks[1]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				3 => new ConfiguredTaskTupleAwaiter3Adapter(
					(tasks[0], tasks[1], tasks[2]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(),
					description),
				4 => new ConfiguredTaskTupleAwaiter4Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3]).ConfigureAwait(continueOnCapturedContext.Value)
					.GetAwaiter(), description),
				5 => new ConfiguredTaskTupleAwaiter5Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4]).ConfigureAwait(continueOnCapturedContext.Value)
					.GetAwaiter(), description),
				6 => new ConfiguredTaskTupleAwaiter6Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				7 => new ConfiguredTaskTupleAwaiter7Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				8 => new ConfiguredTaskTupleAwaiter8Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				9 => new ConfiguredTaskTupleAwaiter9Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				10 => new ConfiguredTaskTupleAwaiter10Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				11 => new ConfiguredTaskTupleAwaiter11Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				12 => new ConfiguredTaskTupleAwaiter12Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(),
					description),
				13 => new ConfiguredTaskTupleAwaiter13Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(),
					description),
				14 => new ConfiguredTaskTupleAwaiter14Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12], tasks[13]).ConfigureAwait(continueOnCapturedContext.Value)
					.GetAwaiter(), description),
				15 => new ConfiguredTaskTupleAwaiter15Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12], tasks[13], tasks[14])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				16 => new ConfiguredTaskTupleAwaiter16Adapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12], tasks[13], tasks[14], tasks[15])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
	...
	public static AwaiterAdapter CreateVoidResultTaskTupleAwaiter(Task[] tasks, bool? continueOnCapturedContext = null)
	{
		if (continueOnCapturedContext != null)
		{
			...
			return tasks.Length switch
			{
				1 => new VoidResultConfiguredTaskAwaiterAdapter(
					ValueTuple.Create(tasks[0]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(),
					$"await ValueTuple.Create(t).ConfigureAwait({continueOnCapturedContext.Value})"),
				2 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				3 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(),
					description),
				4 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3]).ConfigureAwait(continueOnCapturedContext.Value)
					.GetAwaiter(), description),
				5 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4]).ConfigureAwait(continueOnCapturedContext.Value)
					.GetAwaiter(), description),
				6 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				7 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				8 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				9 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				10 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				11 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				12 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(),
					description),
				13 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12]).ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(),
					description),
				14 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12], tasks[13]).ConfigureAwait(continueOnCapturedContext.Value)
					.GetAwaiter(), description),
				15 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12], tasks[13], tasks[14])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				16 => new VoidResultConfiguredTaskAwaiterAdapter(
					(tasks[0], tasks[1], tasks[2], tasks[3], tasks[4], tasks[5], tasks[6], tasks[7], tasks[8], tasks[9],
						tasks[10], tasks[11], tasks[12], tasks[13], tasks[14], tasks[15])
					.ConfigureAwait(continueOnCapturedContext.Value).GetAwaiter(), description),
				_ => throw new ArgumentException($"There is no awaiter for a tuple of {tasks.Length} tasks.",
